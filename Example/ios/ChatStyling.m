...
+ (void) applyStyling
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    [[ZDCChatAvatar appearance] setDefaultAvatarImage:[UIImage imageNamed:@"default_avatar"]];
    
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // Configuring the chat widget/overlay
    ////////////////////////////////////////////////////////////////////////////////////////////////

    [[ZDCChat instance].overlay setEnabled:YES]; // the chat toggle when hitting 'back'
    ...
    UIColor *provataBlue = [UIColor colorWithRed:23/255.f green:167/255.f blue:224/255.f alpha:1.0];
    ...
    [[ZDCVisitorChatCell appearance] setBubbleBorderColor:provataBlue];
    [[ZDCVisitorChatCell appearance] setBubbleColor:provataBlue];
